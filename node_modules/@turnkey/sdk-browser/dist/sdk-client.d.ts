...
export declare class TurnkeyPasskeyClient extends TurnkeyBrowserClient {
    ...
    createPasskeySession: (userId: string, targetEmbeddedKey: string, expirationSeconds?: string, curveType?: "API_KEY_CURVE_P256" | "API_KEY_CURVE_SECP256K1") => Promise<ReadWriteSession>;
}
