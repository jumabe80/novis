...
exports.MultiOwnerPluginAbi = exports.MultiOwnerPluginExecutionFunctionAbi = exports.multiOwnerPluginActions = exports.MultiOwnerPlugin = void 0;
...
const multiOwnerPluginActions = (client) => ({
    ...
    installMultiOwnerPlugin({ account = client.account, overrides, context, ...params }) {
        ...
        if (!(0, aa_core_1.isSmartAccountClient)(client)) {
            throw new aa_core_1.IncompatibleClientError('SmartAccountClient', 'installMultiOwnerPlugin', client);
        }
        ...
        const pluginAddress = params.pluginAddress ??
            exports.MultiOwnerPlugin.meta.addresses[chain.id];
        if (!pluginAddress) {
