...
exports.MultisigPluginAbi = exports.MultisigPluginExecutionFunctionAbi = exports.multisigPluginActions = exports.MultisigPlugin = void 0;
...
exports.MultisigPlugin = {
    ...
    getContract: (client, address) => {
        ...
        return (0, viem_1.getContract)({
            ...
            abi: exports.MultisigPluginAbi,
            client: client,
        });
    },
};
const multisigPluginActions = (client) => ({
    updateOwnership({ args, overrides, context, account = client.account }) {
        ...
        if (!(0, aa_core_1.isSmartAccountClient)(client)) {
            throw new aa_core_1.IncompatibleClientError('SmartAccountClient', 'updateOwnership', client);
        }
        const uo = (0, viem_1.encodeFunctionData)({
            abi: exports.MultisigPluginExecutionFunctionAbi,
    ...
    installMultisigPlugin({ account = client.account, overrides, context, ...params }) {
        ...
        if (!(0, aa_core_1.isSmartAccountClient)(client)) {
            throw new aa_core_1.IncompatibleClientError('SmartAccountClient', 'installMultisigPlugin', client);
        }
        ...
        const pluginAddress = params.pluginAddress ??
            exports.MultisigPlugin.meta.addresses[chain.id];
        if (!pluginAddress) {
            throw new Error('missing MultisigPlugin address for chain ' + chain.name);
        }
        return (0, installPlugin_js_1.installPlugin)(client, {
            pluginAddress,
            pluginInitData: (0, viem_1.encodeAbiParameters)([{ type: 'address[]' }, { type: 'uint256' }], params.args),
            dependencies,
            overrides,
            account,
            context,
    ...
    async readEip712Domain({ account = client.account }) {
        ...
        if (!(0, aa_core_1.isSmartAccountClient)(client)) {
            throw new aa_core_1.IncompatibleClientError('SmartAccountClient', 'readEip712Domain', client);
        }
    ...
    async readIsValidSignature({ args, account = client.account }) {
        ...
        if (!(0, aa_core_1.isSmartAccountClient)(client)) {
            throw new aa_core_1.IncompatibleClientError('SmartAccountClient', 'readIsValidSignature', client);
        }
        return client.readContract({
            address: account.address,
            abi: exports.MultisigPluginExecutionFunctionAbi,
...
exports.multisigPluginActions = multisigPluginActions;
exports.MultisigPluginExecutionFunctionAbi = [
    {
