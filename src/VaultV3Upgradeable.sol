...
contract VaultV3Upgradeable is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuard, UUPSUpgradeable {
    ...
    function _tryAutoBuyAndBurn() internal {
        ...
        uint256 minNovisOut = (burnAmount * SCALE * (BPS_DENOMINATOR - autoSlippageBps)) / BPS_DENOMINATOR;
